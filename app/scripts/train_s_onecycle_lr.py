...
def train_s_model_one_cycle():
    ...
    try:
        ...
        print("Error: Preprocessed SVDB data not found.")
        return
    ...
    class_names = ['N (Normal)', 'S (Supraventricular)']; print("\nValidation Classification Report:"); print(classification_report(all_labels, all_preds, target_names=class_names, zero_division=0))

if __name__ == '__main__':
    train_s_model_one_cycle()